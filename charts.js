...
const LineChart = ({
  ...
  const sList = series && series.length ? series : ["Total Installs", "Organic Share", "DAU", "ARPU"].map((label, i) => ({
    label,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "legend"
  }, sList.map((s, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
...
const BarChart = ({
  ...
  const sList = series || [{
    label: "Sessions",
    values: seededSeries(seed, labs.length, 50, 200)
  }];
  const h = height;
  const padX = 28,
    padY = 24;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "legend"
  }, sList.map((s, j) => /*#__PURE__*/React.createElement("div", {
    key: j,
    className: "legend__item"
  }, /*#__PURE__*/React.createElement("span", {
    className: "legend__sw",
...
const AreaChart = ({
  ...
  const sList = series || [{
    label: "DAU",
    values: smooth(seededSeries(seed, 28, 60, 160))
  }];
  const h = height;
  return /*#__PURE__*/React.createElement("div", {
    ref: ref,
    ...
    width: w,
    height: h
  }, sList.map((s, idx) => /*#__PURE__*/React.createElement("g", {
    key: idx
  }, /*#__PURE__*/React.createElement("path", {
    d: areaPath(s.values, w, h, 24, 20),
    fill: fill
  }), /*#__PURE__*/React.createElement("path", {
    d: linePath(s.values, w, h, 24, 20),
    stroke: stroke,
    fill: "none",
    strokeWidth: "2"
  })))));
...
const Heatmap = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    width: w,
    height: height
  }, data.map((row, r) => row.map((v, c) => /*#__PURE__*/React.createElement("rect", {
    key: `${r}-${c}`,
    x: padL + c * cellW + 1,
    y: padT + r * cellH + 1,
    width: cellW - 2,
    ...
    fill: color(v),
    rx: "2"
  }))), rowLabels && rowLabels.map((lab, r) => /*#__PURE__*/React.createElement("text", {
    key: r,
    x: padL - 6,
    y: padT + r * cellH + cellH / 2 + 3,
    fontSize: "11",
    fill: "#4a5764",
    textAnchor: "end",
    fontWeight: "600"
  }, lab)), colLabels && colLabels.map((lab, c) => /*#__PURE__*/React.createElement("text", {
    key: c,
...
const Funnel = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      display: "grid",
      gridTemplateColumns: "180px 1fr 80px 70px",
      alignItems: "center",
      gap: 12
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      background: i === 0 ? "#2A6BE0" : i === steps.length - 1 ? "#e07a3a" : "#6c91dc"
    }
  })), /*#__PURE__*/React.createElement("div", {
    className: "dt-num",
    style: {
  ...
  }, s.value.toLocaleString()), /*#__PURE__*/React.createElement("div", {
    className: "dt-num muted"
  }, i > 0 ? `${Math.round(s.value / steps[0].value * 100)}%` : "100%"))));
};
...
const StackedArea = ({
  ...
  const layers = [seededSeries(seed + "1", 24, 30, 80), seededSeries(seed + "2", 24, 20, 70), seededSeries(seed + "3", 24, 10, 50)];
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    d: areaBetween(stacks[0], zero),
    fill: COLORS[0],
    opacity: "0.75"
  }), /*#__PURE__*/React.createElement("path", {
    d: areaBetween(stacks[1], stacks[0]),
    fill: COLORS[1],
    opacity: "0.7"
  }), /*#__PURE__*/React.createElement("path", {
    d: areaBetween(stacks[2], stacks[1]),
    fill: COLORS[2],
    opacity: "0.7"
  })));
};
...
const PosteriorChart = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    d: areaFor(ay),
    fill: "rgba(108,145,220,0.25)"
  }), /*#__PURE__*/React.createElement("path", {
    d: areaFor(by),
    fill: "rgba(67,192,138,0.3)"
  }), /*#__PURE__*/React.createElement("path", {
    d: pathFor(ay),
    stroke: "#6c91dc",
    strokeWidth: "2",
  ...
  }), /*#__PURE__*/React.createElement("span", null, "Posterior A")), /*#__PURE__*/React.createElement("div", {
    className: "legend__item"
  }, /*#__PURE__*/React.createElement("span", {
    className: "legend__sw",
    style: {
  ...
  }), /*#__PURE__*/React.createElement("span", null, "Posterior B"))));
};
