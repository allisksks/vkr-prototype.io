...
const App = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }), tool === "hub" && /*#__PURE__*/React.createElement(HubScreen, {
    project: project,
    onNavigate: navigate,
    onProjectChange: setProject
  }), tool === "ems" && /*#__PURE__*/React.createElement(EMSScreen, {
    project: project,
    onProjectChange: setProject,
    onNavigate: navigate,
    ...
    addToast: addToast
  }), tool === "bi" && /*#__PURE__*/React.createElement(BIScreen, {
    project: project,
    onProjectChange: setProject,
    navPayload: navPayload,
    setNavPayload: setNavPayload,
    addToast: addToast,
    onNavigate: navigate
  }), tool === "ab" && /*#__PURE__*/React.createElement(ABScreen, {
    project: project,
    onProjectChange: setProject,
    navPayload: navPayload,
    setNavPayload: setNavPayload,
  ...
  }), tool === "kb" && /*#__PURE__*/React.createElement(KBScreen, {
    kbItems: kbItems,
    navPayload: navPayload,
    setNavPayload: setNavPayload,
    onNavigate: navigate
